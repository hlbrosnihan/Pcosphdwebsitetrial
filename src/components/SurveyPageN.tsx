import {
  ...
  export function SurveyPage() {
    ...
    <p>
      The purpose of the research is to gain an overview of routes into Polycystic Ovarian
      Syndrome care, including where, when, and by whom digital interventions are used.
      What they are and how their users experience them. The study is to help inform a
      heuristic evaluation of applications that are used by patients with PCOS by asking
      patients first what they are using, why, and what it does for them, related to their PCOS.
    </p>
    <p>
      <strong>What Your Participation Involves:</strong> You will be asked to complete a
      survey that takes approximately 15-30 minutes. The survey includes questions about
      your demographics, PCOS diagnosis, digital app usage, medical history, lifestyle
      factors, and quality of life. The research project is being conducted by Hilary Wray
      at Coventry University. You have been selected to take part in this questionnaire
      survey because you have a diagnosis of Polycystic Ovary Syndrome. Your participation
      in the survey is entirely voluntary, and you can opt out at any stage by closing and
      exiting the browser. If you are happy to take part, please answer the following
      questions relating to PCOS treatment routes and digital usage. Your answers will help
      us to understand how you found out about your PCOS and what tools you are using to
      help manage it. As well as how these different interactions impact how you feel.
    </p>
    <p>
      <strong>Confidentiality:</strong> All information you provide will be kept strictly
      confidential. Your data will be anonymized and stored securely in compliance with
      GDPR and data protection regulations. Your personal information will not be shared
      with third parties. All information will be handled in accordance with Coventry
      University Policies, Standards, and Procedures, including our Research Ethics and
      Integrity Statements and our{' '}
      <a
        href="https://www.coventry.ac.uk/gdpr-and-data-protection/privacy-notices/"
        target="_blank"
                ...
                {currentSection < sections.length - 1 ? (
                  ...
                  <div className="flex flex-col items-end gap-2">
                    {submitStatus === 'success' ? (
                      <div className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-teal-50 border border-teal-200 rounded-lg text-teal-800 text-center">
                    ...
                    {submitStatus === 'error' && (
                      <p className="text-red-600 text-sm">
                        Something went wrong. Please try again or contact the research team.
                      </p>
                    )}
                  </div>
                )}
